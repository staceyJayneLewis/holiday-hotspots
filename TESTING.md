...
- https://validator.w3.org/nu/?doc=https%3A%2F%2FstaceyJayneLewis.github.io%2Fholiday-hotspots%2Findex.html
...
| --- | --- | --- | --- |
| Home | [W3C](https://validator.w3.org/nu/?doc=https%3A%2F%2FstaceyJayneLewis.github.io%2Fholiday-hotspots%2Findex.html) | ![screenshot](documentation/html-validation-home.png) | Section lacks header h2-h6 warning |
| Contact | [W3C](https://validator.w3.org/nu/?doc=https%3A%2F%2FstaceyJayneLewis.github.io%2Fholiday-hotspots%2Fcontact.html) | ![screenshot](documentation/html-validation-contact.png) | obsolete iframe warnings |
| Quiz | [W3C](https://validator.w3.org/nu/?doc=https%3A%2F%2FstaceyJayneLewis.github.io%2Fholiday-hotspots%2Fquiz.html) | ![screenshot](documentation/html-validation-quiz.png) | Pass: No Errors |
...
- https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2FstaceyJayneLewis.github.io%2Fholiday-hotspots
...
| --- | --- | --- | --- |
| style.css | [Jigsaw](https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2FstaceyJayneLewis.github.io%2Fholiday-hotspots) | ![screenshot](documentation/css-validation-style.png) | Pass: No Errors |
...
Alternatively, use this link: https://github.com/staceyJayneLewis/holiday-hotspots/issues
...
Any remaining open issues can be tracked [here](https://github.com/staceyJayneLewis/holiday-hotspots/issues).

| Bug | Status |
| --- | --- |
| [JS `'let'` or `'const'` or `'template literal syntax'` or `'arrow function syntax (=>)'` is available in ES6 (use `'esversion: 11'`) or Mozilla JS extensions (use moz).](https://github.com/staceyJayneLewis/holiday-hotspots/issues/4) | Open |
| [Python `E501 line too long` (93 > 79 characters)](https://github.com/staceyJayneLewis/holiday-hotspots/issues/5) | Open |
