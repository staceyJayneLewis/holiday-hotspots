...
- As a returning visitor, I want to be able to find links to the holiday hotspots social media or email so I can contact with  
...
- As a site adminsitstrator, I should be able to see each function labelled with multi-line comments so that I understand the purpose of each function.
...
- [surveyMonkey](https://www.surveymonkey.com/r/VYM2FCZ) used to conduct survey for consumer behaviours
...
- I would like to thank my Code Institute mentor, [Juliia Konovalova](https://github.com/IuliiaKonovalova) for their support throughout the development of this project. Juliia went above and beyond to help using the api's for the first time and I now feel more confident using them.
